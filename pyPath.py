...
class MYPATH:
    ...
    def make_redirecting_bashfile(self, filename, target_pyfile="", content_edited=None, allow_args=False,
                                  max_num_args=0):
        if not allow_args:
            default_command = f"""
#!/bin/bash
...
python3  {target_pyfile} {sub}
    ...
    def addfile_to_path(self, path, file_name, exe, permissions=None):
